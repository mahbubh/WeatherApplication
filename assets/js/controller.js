...
app.controller('weatherCtrl', ['$scope', 'weatherService', function($scope, weatherService) {
	...
	function fetchWeatherDetails(woeid){
		weatherService.getWeatherDetails(woeid).then(function(data){
			...
			//console.log(data.consolidated_weather[0].the_temp + " - " + data.consolidated_weather[1].the_temp + " - " + data.consolidated_weather[2].the_temp + " - " + data.consolidated_weather[3].the_temp + " - " + data.consolidated_weather[4].the_temp);
			$scope.fiveDayAvgTemp = (data.consolidated_weather[0].the_temp+data.consolidated_weather[1].the_temp+data.consolidated_weather[2].the_temp+data.consolidated_weather[3].the_temp+data.consolidated_weather[4].the_temp)/5;
